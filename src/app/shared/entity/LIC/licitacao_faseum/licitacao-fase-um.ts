 ...
 */
export class LicitacaoFaseUm extends BaseEntity<String> {
  /**
 ...
 */
export interface LoteFaseUm extends BaseEntity<String> {
  /**
   * Descrição do Lote
   */
 ...
 */
export interface ItemLoteFaseUm extends BaseEntity<String> {
  /**
